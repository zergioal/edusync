        ...
        <form onSubmit={submit} className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <label className="flex flex-col gap-1">
              <span className="text-xs font-semibold text-fg-muted uppercase tracking-wide">Apellidos</span>
          ...
          {!isEdit && (
            <p className="text-xs text-fg-muted">
              Contraseña temporal: <code className="font-mono bg-surface-2 px-1 rounded">Padre2026#</code>
            </p>
          )}
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-fg-muted mt-0.5">Selecciona un curso para ver los tutores del grado</p>
          </div>
      ...
      <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-fg-muted">— Padres/Tutores</span>
          </div>
          <Button onClick={() => setModal('new')}>+ Registrar padre/tutor</Button>
        </div>
      </div>
