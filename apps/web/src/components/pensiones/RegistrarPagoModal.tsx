      ...
      <div className="w-full max-w-md bg-surface rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="bg-bg rounded-xl p-3 space-y-1">
            ...
            <p className="text-xs text-fg-muted">Código: {pension.estudiante.codigo}</p>
            <p className="text-lg font-bold text-fg mt-1">Bs. {pension.monto.toFixed(2)}</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-sm font-medium text-fg mb-1">N° de comprobante</label>
              <input
                type="text"
                value={comprobante}
