      ...
      return (
        <div className="flex min-h-screen items-center justify-center bg-bg p-6">
          <div className="max-w-md w-full text-center space-y-4">
            ...
            <h1 className="text-xl font-bold text-fg">Algo salió mal</h1>
            ...
            <div className="flex justify-center gap-3">
              ...
              <button
                ...
                className="rounded-lg border border-border px-4 py-2 text-sm font-medium text-fg hover:bg-surface-2"
              >
                Volver al inicio
              </button>
            </div>
