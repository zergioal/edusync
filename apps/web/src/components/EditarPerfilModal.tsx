  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl space-y-4">
        <h2 className="text-lg font-bold text-gray-900">Editar mis datos</h2>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <label className="flex flex-col gap-1">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Grado académico</span>
            <input
            ...
            <span className="text-xs text-gray-400">Opcional — escribe el que corresponda a tu formación.</span>
          </label>
