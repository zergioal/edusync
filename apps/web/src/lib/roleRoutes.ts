...
export const NAV_POR_ROL: Record<string, NavItem[]> = {
  director: [
    ...
    {
      to: "/dashboard/director/estudiantes",
      label: "Estudiantes",
      icon: "student",
    },
    {
      to: "/dashboard/director/padres",
    ...
    {
      to: "/dashboard/director/paralelos",
      label: "Cursos y Paralelos",
      icon: "users",
    },
    {
      to: "/dashboard/director/gestiones",
      label: "Gestión Académica",
      icon: "calendar",
    },
    {
      to: "/dashboard/director/areas-subareas",
    ...
    {
      to: "/dashboard/director/ajustes-institucionales",
      label: "Ajustes Institucionales",
      icon: "settings",
    },
    {
      to: "/dashboard/director/auditoria",
      label: "Auditoría",
      icon: "settings",
    },
  ...
  regente: [
    ...
    {
      to: "/dashboard/regente/estudiantes",
      label: "Estudiantes",
      icon: "student",
    },
    {
      to: "/dashboard/regente/asistencia",
      label: "Asistencia Diaria",
      icon: "users",
    },
    {
      to: "/dashboard/regente/reporte",
      label: "Reporte Asistencia",
      icon: "chart",
    },
    {
      to: "/dashboard/regente/inasistencias",
      label: "Comunicados Inasist.",
      icon: "bell",
    },
  ...
  coordinador: [
    ...
    {
      to: "/dashboard/coordinador/estudiantes",
      label: "Estudiantes",
      icon: "student",
    },
    {
      to: "/dashboard/coordinador/padres",
      label: "Padres / Tutores",
      icon: "child",
    },
    {
      to: "/dashboard/coordinador/docentes",
      label: "Docentes",
      icon: "teacher",
    },
    {
    ...
    {
      to: "/dashboard/coordinador/gestiones",
      label: "Gestión Académica",
      icon: "calendar",
    },
    {
      to: "/dashboard/coordinador/areas-subareas",
      label: "Áreas y Subáreas",
      icon: "book",
    },
    {
    ...
    {
      to: "/dashboard/coordinador/anuncios",
      label: "Comunicados",
      icon: "bell",
    },
    {
      to: "/dashboard/coordinador/mensajes",
      label: "Mensajes",
      icon: "folder",
    },
  ],
  admin: [
    ...
    {
      to: "/dashboard/admin/instituciones",
      label: "Instituciones",
      icon: "users",
    },
    {
      to: "/dashboard/admin/estudiantes",
      label: "Estudiantes",
      icon: "student",
    },
    ...
    {
      to: "/dashboard/admin/areas-subareas",
      label: "Áreas y Subáreas",
      icon: "book",
    },
    {
    ...
    {
      to: "/dashboard/admin/proyectos-bth",
      label: "Proyectos BTH",
      icon: "book",
    },
  ...
  docente: [
    ...
    {
      to: "/dashboard/docente/asignaciones",
      label: "Mis Materias",
      icon: "book",
    },
    {
  ...
  estudiante: [
    ...
    {
      to: "/dashboard/estudiante/control-diario",
      label: "Control diario",
      icon: "tasks",
    },
    {
    ...
    {
      to: "/dashboard/estudiante/boletin",
      label: "Mi Boletín",
      icon: "folder",
    },
    {
      to: "/dashboard/estudiante/proyecto-bth",
      label: "Proyecto BTH",
      icon: "book",
    },
    {
      to: "/dashboard/estudiante/anuncios",
      label: "Comunicados",
      icon: "bell",
    },
  ...
  padre: [
    ...
    {
      to: "/dashboard/padre/calendario",
      label: "Calendario",
      icon: "calendar",
    },
    {
      to: "/dashboard/padre/control-diario",
      label: "Control diario",
      icon: "tasks",
    },
    { to: "/dashboard/padre/boletin", label: "Boletín", icon: "folder" },
    {
      to: "/dashboard/padre/proyecto-bth",
      label: "Proyecto BTH",
      icon: "book",
    },
...
export function getNavGroup(rol: Rol): NavItem[] {
  switch (rol) {
    case Rol.DIRECTOR:
      return NAV_POR_ROL["director"] ?? [];
    case Rol.REGENTE:
      return NAV_POR_ROL["regente"] ?? [];
    case Rol.SECRETARIA:
      return NAV_POR_ROL["secretaria"] ?? [];
    case Rol.CONTADOR:
      return NAV_POR_ROL["contador"] ?? [];
    case Rol.ADMIN_SISTEMA:
      return NAV_POR_ROL["admin"] ?? [];
    case Rol.COORDINADOR:
      return NAV_POR_ROL["coordinador"] ?? [];
    case Rol.DOCENTE:
      return NAV_POR_ROL["docente"] ?? [];
    case Rol.ESTUDIANTE:
      return NAV_POR_ROL["estudiante"] ?? [];
    case Rol.PADRE_TUTOR:
      return NAV_POR_ROL["padre"] ?? [];
    default:
      return NAV_POR_ROL["admin"] ?? [];
  }
}
