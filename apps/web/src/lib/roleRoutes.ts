...
export const NAV_POR_ROL: Record<string, NavItem[]> = {
  director: [
    ...
    { to: '/dashboard/director/padres',           label: 'Padres / Tutores',     icon: 'child'    },
    { to: '/dashboard/director/docentes',         label: 'Docentes',             icon: 'teacher'  },
    { to: '/dashboard/director/personal',         label: 'Personal',             icon: 'teacher'  },
    { to: '/dashboard/director/paralelos',        label: 'Cursos y Paralelos',   icon: 'users'    },
    { to: '/dashboard/director/gestiones',        label: 'Gestión Académica',    icon: 'calendar' },
    { to: '/dashboard/director/areas-subareas',   label: 'Áreas y Subáreas',     icon: 'book'     },
    ...
    { to: '/dashboard/director/reportes',         label: 'Reportes Académicos',  icon: 'chart'    },
  ...
  regente: [
    ...
    { to: '/dashboard/regente/estudiantes',       label: 'Estudiantes',          icon: 'student'  },
  ...
  coordinador: [
    ...
    { to: '/dashboard/coordinador/padres',            label: 'Padres / Tutores',     icon: 'child'    },
    ...
    { to: '/dashboard/coordinador/areas-subareas',    label: 'Áreas y Subáreas',     icon: 'book'     },
  ...
  admin: [
    ...
    { to: '/dashboard/admin/areas-subareas', label: 'Áreas y Subáreas',  icon: 'book'     },
  ...
  contador: [
    ...
    { to: '/dashboard/admin/estudiantes',    label: 'Estudiantes',    icon: 'student'  },
    { to: '/dashboard/admin/finanzas',       label: 'Finanzas',       icon: 'cash'     },
    { to: '/dashboard/admin/finanzas/tarifas', label: 'Configuración', icon: 'settings' },
    { to: '/dashboard/admin/anuncios',       label: 'Comunicados',    icon: 'bell'     },
    { to: '/dashboard/admin/mensajes',       label: 'Mensajes',       icon: 'folder'   },
  ],
  docente: [
    ...
    { to: '/dashboard/docente/estudiantes',       label: 'Mis Estudiantes', icon: 'student' },
    { to: '/dashboard/docente/calificaciones',    label: 'Registro de notas y asistencia', icon: 'chart' },
    { to: '/dashboard/docente/control-diario',    label: 'Control diario', icon: 'tasks'   },
  ...
  estudiante: [
    ...
    { to: '/dashboard/estudiante/control-diario', label: 'Control diario', icon: 'tasks'   },
